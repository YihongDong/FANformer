...
class FANLayer(nn.Module):
    ...
    Args:
        ...
        p_ratio (float): The ratio of output dimensions used for cosine and sine parts (default: 0.125).
    ...
    def __init__(self, input_dim, output_dim, p_ratio=0.125, activation=None, use_p_bias=True):
